...
$(document).ready(function () {
    ...
    function toggleRangePeriod() {
      var rangeBox = document.getElementById('timespan');
      ...
      var searchBox = document.getElementsByClassName('input-group');      
      if (rangeBox.style.height == '0px') {
        ...
        searchBox[0].style.top = 'calc(100vh - 94px)';
        leftSideList.style.maxHeight =  'calc(100vh - 94px)';
      }
      else {
        ...
        searchBox[0].style.top = 'calc(100vh - 32px)';
        leftSideList.style.maxHeight =  'calc(100vh - 32px)';
      }
    }
